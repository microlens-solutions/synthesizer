    ...
    public sealed class DateTimeOffsetProvider : ProviderBase, IDataTypeProvider, INamespaceProvider {
        public bool CanHandle(PropertyMetadata metadata) {
            return metadata != null && metadata.Type != null && metadata.Type.ContainingNamespace != null
                ...
                && string.Equals(metadata.Type.Name, "DateTimeOffset", StringComparison.OrdinalIgnoreCase) && string.Equals(metadata.Type.ContainingNamespace.Name, "System", StringComparison.OrdinalIgnoreCase);
        }
